...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_WHILE = 280,                 /* T_WHILE  */
    T_GOTO = 281,                  /* T_GOTO  */
    T_SH_ASSIGN_PLUS = 282,        /* T_SH_ASSIGN_PLUS  */
    T_SH_ASSIGN_MINUS = 283,       /* T_SH_ASSIGN_MINUS  */
    T_SH_ASSIGN_MULT = 284,        /* T_SH_ASSIGN_MULT  */
    T_SH_ASSIGN_DIV = 285,         /* T_SH_ASSIGN_DIV  */
    T_SH_ASSIGN_MOD = 286,         /* T_SH_ASSIGN_MOD  */
    T_LOCAL = 287,                 /* T_LOCAL  */
