...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_IDENT = 267,                 /* T_IDENT  */
    T_NUM = 268,                   /* T_NUM  */
    T_FLOATING_POINT_NUMBER = 269, /* T_FLOATING_POINT_NUMBER  */
    T_STRING = 270,                /* T_STRING  */
    T_CHARACTER = 271,             /* T_CHARACTER  */
    T_CONST = 272,                 /* T_CONST  */
    T_TRUE = 273,                  /* T_TRUE  */
    T_FALSE = 274,                 /* T_FALSE  */
    T_FUNC = 275,                  /* T_FUNC  */
    T_DOTDOT = 276,                /* T_DOTDOT  */
    T_PLUSPLUS = 277,              /* T_PLUSPLUS  */
    T_MINUSMINUS = 278,            /* T_MINUSMINUS  */
    T_IF = 279,                    /* T_IF  */
    T_ELSE = 280,                  /* T_ELSE  */
    T_WHILE = 281,                 /* T_WHILE  */
    T_GOTO = 282,                  /* T_GOTO  */
    ...
    T_SWITCH = 288,                /* T_SWITCH  */
    T_CASE = 289,                  /* T_CASE  */
    T_DEFAULT = 290,               /* T_DEFAULT  */
    T_BREAK = 291,                 /* T_BREAK  */
