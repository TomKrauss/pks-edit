...
EdExitAndSave(long ), EdExit(long ), EdCloseAll(),
...
{/*3*/   EdBlockDelete , -1,EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH | EW_NEEDSBLK | 0,                 "DeleteBlock",                NULL,  "iWi"                                          },
{/*4*/   EdBlockFindEnd, -1,EW_NEEDSCURRF | EW_NEEDSBLK | 0,                                           "FindBlockEnd",               NULL,  "iW"                                           },
{/*5*/   EdBlockFindStart, -1,  EW_NEEDSCURRF | EW_NEEDSBLK | 0,                                       "FindBlockStart",             NULL,  "iW"                                           },
...
{/*49*/  EdFindAgain, -1, EW_NEEDSCURRF | 0,                                                           "FindAgain",                  NULL,  "iWeDIR_"                                      },
{/*50*/  EdReplaceAgain, -1, EW_MODIFY | EW_NEEDSCURRF | 0,                                            "ReplaceAgain",               NULL,  "iW"                                           },
...
{/*66*/  EdCommandExecute, -1, EW_HASFORM | 0,                                                         "ExecuteCommandDialog",       NULL,  "ibFORM_ssseEX_"                              },
{/*67*/  EdExecute, -1, EW_HASFORM | 0,                                                                "ExecuteCommand",             NULL,  "ieEX_sss"                              },
{/*68*/  EdShiftBetweenBrackets, -1, EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH | 0,                      "ShiftBetweenBrackets",       NULL,  "iWeDIR_"                                      },
{/*69*/  EdSort, -1, EW_MODIFY | EW_NEEDSCURRF | 0,                                                    "Sort",                       NULL,  "ibFORM_ssseRNG_eSO_"                         },
{/*70*/  EdLinesShift, -1, EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH | EW_MULTI | 0,                     "ShiftLines",                 NULL,  "iWeDIR_"                                      },
...
{/*84*/  EdFindWordCursor, -1, EW_NEEDSCURRF | EW_FINDCURS | 0,                                        "CursorFindWord",             NULL,  "iWeDIR_"                                      },
...
{/*90*/EdScrollScreen, -1, EW_NEEDSCURRF | 0,                                                          "ScrollScreen",               NULL,  "iWeMOT_"                                      },
{/*91*/EdScrollCursor, -1, EW_NEEDSCURRF | 0,                                                          "ScrollCursor",               NULL,  "iWeMOT_"                                      },
