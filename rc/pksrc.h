...
#define IDS_SEGMENTATION_FAULT_EXECUTING_MACRO2 217
#define IDS_HUGE_CLIPBOARD_DO_YOU_WANT_TO_COPY 217
#define IDS_READING_LARGE_FILE          218
...
#define DLGCONTROLINS                   536
#define DLGRANGESELECTION               538
