...
EdAlignText(long ), 
EdMouseMarkParts(long ), EdMouseMoveText(long ), edit_selectLinesWithMouse(long ), EdMousePositionUngrabbed(long ),
EdAlert(long ), error_displayAlertBoxWithOptions(long ), EdPromptAssign(long ), interpreter_sprintf(long ),
macro_getSelectedText(long ), edit_hideSelectedLines(long ), edit_makeHiddenLineVisible(long ), macroc_substituteStringWith(long ),
edit_expandAbbreviation(long ), EdConfigureIcons(long ), EdHelpContext(long ), EdListBindings(long ),
EdCompileMacros(long ), EdDocTypes(long ), EdIsDefined(long ), ft_cloneWindow(BOOL bLink),
...
macroc_fileListFiles(), edit_replaceText(), edit_getAllEditors(), edit_getCaretPosition(), macroc_pathCreateFromSegments(), edit_getSelectedLineRange(), edit_getLineLen(), edit_setCaret(), edit_getLineText(),macroc_findPattern(), edit_replaceLines(), edit_replaceSpacesWithTabs(), edit_replaceTabsWithSpaces(), op_changeEditorOption();
...
{/*32*/  edit_splitLine, -1, EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH,                                 "SplitLine",                  NULL,  "iWeRET_"                                      },
...
{/*98*/edit_selectLinesWithMouse, -1, EW_NEEDSCURRF | EW_FINDCURS,                                        "MouseSelectLines",           NULL,  "iWi"                                      },
...
{/*105*/edit_hideSelectedLines, -1, EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH,                                  "HideLines",                  NULL,  "iW"                                           },
{/*106*/edit_makeHiddenLineVisible, -1, EW_MODIFY | EW_NEEDSCURRF | EW_UNDOFLSH,                                 "UnHideLine",                 NULL,  "iW"                                           },
{/*107*/macroc_substituteStringWith, -1, 0,                                                            "StringReplace",              NULL,  "ssssbRE_i"                                  },
{/*108*/edit_expandAbbreviation, -1, 0,                                                                   "ExpandAbbreviation",         NULL,  "i"                                           },
...
{/*122*/ft_cloneWindow, -1, EW_NEEDSCURRF,                                                             "CloneWindow",                NULL,  "iWi"                                          },
...
1, C_1FUNC, 58 /* EdEditFile */, 							1, OPEN_FILE_NO_FILE_SELECTION, "open-new-file",
2, C_1FUNC, 58 /* EdEditFile */, 							1, OPEN_DIRGIVEN, "open-file-dir-given",
3, C_1FUNC, 58 /* EdEditFile */, 							1, OPEN_FILE_NO_FILE_SELECTION|OPEN_NEW_WITH_FILE_SELECTION, "open-new-file-named",
4, C_1FUNC, 58 /* EdEditFile */, 							1, OPEN_FILE_NO_FILE_SELECTION|OPEN_HISTORY|0x0000, "open-history",
...
134, C_1FUNC, 41 /* EdCharDelete */, 						1, MOT_WORD, "delete-word",
135, C_1FUNC, 41 /* EdCharDelete */, 						1, MOT_UNTILC, "delete-to-next-char",
136, C_1FUNC, 41 /* EdCharDelete */, 						1, -MOT_SPACE, "delete-back-white",
137, C_1FUNC, 41 /* EdCharDelete */, 						1, MOT_SPACE, "delete-to-white",
138, C_1FUNC, 41 /* EdCharDelete */, 						1, -MOT_TOEND, "delete-to-sol",
139, C_1FUNC, 41 /* EdCharDelete */, 						1, -MOT_WORD, "delete-back-word",
140, C_1FUNC, 41 /* EdCharDelete */, 						1, -MOT_UNTILC, "delete-until-previous-char",
141, C_1FUNC, 17 /* EdCharInsert */, 						1, 13 , "split-line",
142, C_1FUNC, 32 /* edit_splitLine */, 						1, RET_PLUS , "split-line-indent-plus",
143, C_1FUNC, 32 /* edit_splitLine */, 						1, RET_MINUS , "split-line-indent-minus",
...
153, C_1FUNC, 37 /* EdCursorRight */, 						1, MOT_WORD, "cursor-right-word",
...
157, C_1FUNC, 38 /* EdCursorLeft */, 						1, MOT_WORD, "cursor-left-word",
...
167, C_0FUNC, 0 /* EdRereadFileFromDisk */, 						1, 0 , "discard-changes-in-file",
...
173, C_0FUNC, 30 /* EdSetMultiplier */, 					1, 0 , "set-multiplier",
...
197, C_1FUNC, 122 /* ft_cloneWindow */,                     1, TRUE, "clone-window-for-wysiwyg",
...
205, C_1FUNC, 98 /* edit_selectLinesWithMouse */, 					1, 1 , "mouse-select-lines",
206, C_1FUNC, 98 /* edit_selectLinesWithMouse */, 					1, 0 , "mouse-unselect-lines",
...
236, C_1FUNC, 122 /* ft_cloneWindow */, 					1, 0, "clone-window",
